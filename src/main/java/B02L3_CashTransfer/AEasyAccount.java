...
public class AEasyAccount {
    ...
    public static void printEasyAccount(AEasyAccount account) {
        System.out.println("Account whith ID: " + account.getAccountId() +
                " has " + account.getAccountBalance() + " USD");
    }

    public static void printEasyAccount(AEasyAccount[] accounts) {
        for (AEasyAccount e: accounts) {
    ...
    public static boolean transfer01(AEasyAccount[] accounts, int[] cash) throws Throwable {
        boolean result = true;
        int brIndex = -1;
    ...
    private static void attemptForward(AEasyAccount e, int cash) throws ZedDeadBabyExtension, InterruptedException {
        try {
    ...
    private static void attemptBack(AEasyAccount e, int cash) {
        try {
